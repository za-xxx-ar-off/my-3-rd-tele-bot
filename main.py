...
if image:
await context.bot.send_photo(chat_id, image, caption=question, reply_markup=keyboard_answers())
else:
await context.bot.send_message(chat_id, question, reply_markup=keyboard_answers())
...
async def callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    db.set(chat_id, row + 1)
    await send_question(chat_id, context)
>>>>>>> 7cc7cfb5b14cac57ca91df02f62756f500747cd5
